var model;
var modelUrl = window.urlApi + "odata/SimCard";
$(document).ready(function () {
    var PagedGridModel = function (items) {
        ...
        this.addItem = function () {
            var novoItem = ko.mapping.fromJS({ ClienteId: ko.observable(0), DDD: ko.observable(""), Telefone: ko.observable(""), PIN: ko.observable(""), PUK: ko.observable(""), ICCID: ko.observable(""), PlanoDados: ko.observable("") });
        ...
        this.gridOptions = {
            ...
            , columnDefs: [
                { field: "DDD", displayName: "DDD" },
                { field: "Telefone", displayName: "Telefone" },
                { field: "PIN", displayName: "PIN" },
                { field: "PUK", displayName: "PUK" },
                { field: "ICCID", displayName: "ICCID" },
                { field: "PlanoDados", displayName: "Plano de Dados" }
            ]
        };
    };
